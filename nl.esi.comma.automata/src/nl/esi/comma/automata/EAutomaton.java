...
public class EAutomaton {
	...
	public ScenarioComputeResult computeScenarios(AlgorithmType algorithmType) {
		return computeScenarios(algorithmType, new ArrayList<>());
	}
	
	public ScenarioComputeResult computeScenarios(AlgorithmType algorithmType, List<String> existingScenarios) {
