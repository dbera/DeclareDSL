...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Alternate Precedence</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#isEitherB <em>Either B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#getRefB <em>Ref B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#isEitherA <em>Either A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#getRefA <em>Ref A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#isNot <em>Not</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#isEitherC <em>Either C</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.AlternatePrecedenceImpl#getRefC <em>Ref C</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlternatePrecedenceImpl extends MinimalEObjectImpl.Container implements AlternatePrecedence
{
  /**
   ...
   * @generated
   */
  protected AlternatePrecedenceImpl()
  {
    super();
  }
  ...
  {
    return SclPackage.Literals.ALTERNATE_PRECEDENCE;
  }
  ...
  public void setEitherB(boolean newEitherB)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.ALTERNATE_PRECEDENCE__EITHER_B, oldEitherB, eitherB));
  }
  ...
  public EList<Ref> getRefB()
  {
    if (refB == null)
    {
      refB = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.ALTERNATE_PRECEDENCE__REF_B);
    }
    return refB;
  }
  ...
  public void setEitherA(boolean newEitherA)
  {
    ...
    eitherA = newEitherA;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.ALTERNATE_PRECEDENCE__EITHER_A, oldEitherA, eitherA));
  }
  ...
  public EList<Ref> getRefA()
  {
    if (refA == null)
    {
      refA = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.ALTERNATE_PRECEDENCE__REF_A);
    }
    return refA;
  }
  ...
  public void setMinVal(int newMinVal)
  {
    ...
    minVal = newMinVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.ALTERNATE_PRECEDENCE__MIN_VAL, oldMinVal, minVal));
  }
  ...
  public void setMaxVal(int newMaxVal)
  {
    ...
    maxVal = newMaxVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.ALTERNATE_PRECEDENCE__MAX_VAL, oldMaxVal, maxVal));
  }
  ...
  public void setNot(boolean newNot)
  {
    ...
    not = newNot;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.ALTERNATE_PRECEDENCE__NOT, oldNot, not));
  }
  ...
  public void setEitherC(boolean newEitherC)
  {
    ...
    eitherC = newEitherC;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.ALTERNATE_PRECEDENCE__EITHER_C, oldEitherC, eitherC));
  }
  ...
  public EList<Ref> getRefC()
  {
    if (refC == null)
    {
      refC = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.ALTERNATE_PRECEDENCE__REF_C);
    }
    return refC;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SclPackage.ALTERNATE_PRECEDENCE__REF_B:
        return ((InternalEList<?>)getRefB()).basicRemove(otherEnd, msgs);
      case SclPackage.ALTERNATE_PRECEDENCE__REF_A:
        return ((InternalEList<?>)getRefA()).basicRemove(otherEnd, msgs);
      case SclPackage.ALTERNATE_PRECEDENCE__REF_C:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SclPackage.ALTERNATE_PRECEDENCE__EITHER_B:
        return isEitherB();
      case SclPackage.ALTERNATE_PRECEDENCE__REF_B:
        return getRefB();
      case SclPackage.ALTERNATE_PRECEDENCE__EITHER_A:
        return isEitherA();
      case SclPackage.ALTERNATE_PRECEDENCE__REF_A:
        return getRefA();
      case SclPackage.ALTERNATE_PRECEDENCE__MIN_VAL:
        return getMinVal();
      case SclPackage.ALTERNATE_PRECEDENCE__MAX_VAL:
        return getMaxVal();
      case SclPackage.ALTERNATE_PRECEDENCE__NOT:
        return isNot();
      case SclPackage.ALTERNATE_PRECEDENCE__EITHER_C:
        return isEitherC();
      case SclPackage.ALTERNATE_PRECEDENCE__REF_C:
        return getRefC();
    }
