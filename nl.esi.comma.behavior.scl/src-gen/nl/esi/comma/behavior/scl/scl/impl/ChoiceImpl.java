 ...
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChoiceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChoiceImpl extends MinimalEObjectImpl.Container implements Choice
{
  ...
  {
    return SclPackage.Literals.CHOICE;
  }
  ...
  public EList<EObject> getType()
  {
    if (type == null)
    {
      type = new EObjectContainmentEList<EObject>(EObject.class, this, SclPackage.CHOICE__TYPE);
    }
    return type;
  }
