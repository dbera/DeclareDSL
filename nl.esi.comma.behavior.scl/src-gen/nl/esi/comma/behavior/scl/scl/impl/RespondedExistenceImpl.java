...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Responded Existence</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.RespondedExistenceImpl#isEitherA <em>Either A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.RespondedExistenceImpl#getRefA <em>Ref A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.RespondedExistenceImpl#isEitherB <em>Either B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.RespondedExistenceImpl#getRefB <em>Ref B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RespondedExistenceImpl extends MinimalEObjectImpl.Container implements RespondedExistence
{
  /**
   ...
   * @generated
   */
  protected RespondedExistenceImpl()
  {
    super();
  }
  ...
  {
    return SclPackage.Literals.RESPONDED_EXISTENCE;
  }
  ...
  public void setEitherA(boolean newEitherA)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.RESPONDED_EXISTENCE__EITHER_A, oldEitherA, eitherA));
  }
  ...
  public EList<Ref> getRefA()
  {
    if (refA == null)
    {
      refA = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.RESPONDED_EXISTENCE__REF_A);
    }
    return refA;
  }
  ...
  public void setEitherB(boolean newEitherB)
  {
    ...
    eitherB = newEitherB;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.RESPONDED_EXISTENCE__EITHER_B, oldEitherB, eitherB));
  }
  ...
  public EList<Ref> getRefB()
  {
    if (refB == null)
    {
      refB = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.RESPONDED_EXISTENCE__REF_B);
    }
    return refB;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SclPackage.RESPONDED_EXISTENCE__REF_A:
        return ((InternalEList<?>)getRefA()).basicRemove(otherEnd, msgs);
      case SclPackage.RESPONDED_EXISTENCE__REF_B:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SclPackage.RESPONDED_EXISTENCE__EITHER_A:
        return isEitherA();
      case SclPackage.RESPONDED_EXISTENCE__REF_A:
        return getRefA();
      case SclPackage.RESPONDED_EXISTENCE__EITHER_B:
        return isEitherB();
      case SclPackage.RESPONDED_EXISTENCE__REF_B:
        return getRefB();
    }
