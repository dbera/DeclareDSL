...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Chain Precedence</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#isEitherB <em>Either B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#getRefB <em>Ref B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#isEitherA <em>Either A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#getRefA <em>Ref A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#isNot <em>Not</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainPrecedenceImpl#getMaxVal <em>Max Val</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChainPrecedenceImpl extends MinimalEObjectImpl.Container implements ChainPrecedence
{
  /**
  ...
  {
    return SclPackage.Literals.CHAIN_PRECEDENCE;
  }
  ...
  public void setEitherB(boolean newEitherB)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_PRECEDENCE__EITHER_B, oldEitherB, eitherB));
  }
  ...
  public EList<Ref> getRefB()
  {
    if (refB == null)
    {
      refB = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.CHAIN_PRECEDENCE__REF_B);
    }
    return refB;
  }
  ...
  public void setEitherA(boolean newEitherA)
  {
    ...
    eitherA = newEitherA;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_PRECEDENCE__EITHER_A, oldEitherA, eitherA));
  }
  ...
  public EList<Ref> getRefA()
  {
    if (refA == null)
    {
      refA = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.CHAIN_PRECEDENCE__REF_A);
    }
    return refA;
  }
  ...
  public void setNot(boolean newNot)
  {
    ...
    not = newNot;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_PRECEDENCE__NOT, oldNot, not));
  }
  ...
  public void setMinVal(int newMinVal)
  {
    ...
    minVal = newMinVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_PRECEDENCE__MIN_VAL, oldMinVal, minVal));
  }
  ...
  public void setMaxVal(int newMaxVal)
  {
    ...
    maxVal = newMaxVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_PRECEDENCE__MAX_VAL, oldMaxVal, maxVal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SclPackage.CHAIN_PRECEDENCE__REF_B:
        return ((InternalEList<?>)getRefB()).basicRemove(otherEnd, msgs);
      case SclPackage.CHAIN_PRECEDENCE__REF_A:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SclPackage.CHAIN_PRECEDENCE__EITHER_B:
        return isEitherB();
      case SclPackage.CHAIN_PRECEDENCE__REF_B:
        return getRefB();
      case SclPackage.CHAIN_PRECEDENCE__EITHER_A:
        return isEitherA();
      case SclPackage.CHAIN_PRECEDENCE__REF_A:
        return getRefA();
      case SclPackage.CHAIN_PRECEDENCE__NOT:
        return isNot();
      case SclPackage.CHAIN_PRECEDENCE__MIN_VAL:
        return getMinVal();
      case SclPackage.CHAIN_PRECEDENCE__MAX_VAL:
        return getMaxVal();
    }
