...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Chain Succession</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainSuccessionImpl#isEitherA <em>Either A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainSuccessionImpl#getRefA <em>Ref A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainSuccessionImpl#isEitherB <em>Either B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainSuccessionImpl#getRefB <em>Ref B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainSuccessionImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.ChainSuccessionImpl#getMaxVal <em>Max Val</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChainSuccessionImpl extends MinimalEObjectImpl.Container implements ChainSuccession
{
  /**
  ...
  {
    return SclPackage.Literals.CHAIN_SUCCESSION;
  }
  ...
  public void setEitherA(boolean newEitherA)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_SUCCESSION__EITHER_A, oldEitherA, eitherA));
  }
  ...
  public EList<Ref> getRefA()
  {
    if (refA == null)
    {
      refA = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.CHAIN_SUCCESSION__REF_A);
    }
    return refA;
  }
  ...
  public void setEitherB(boolean newEitherB)
  {
    ...
    eitherB = newEitherB;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_SUCCESSION__EITHER_B, oldEitherB, eitherB));
  }
  ...
  public EList<Ref> getRefB()
  {
    if (refB == null)
    {
      refB = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.CHAIN_SUCCESSION__REF_B);
    }
    return refB;
  }
  ...
  public void setMinVal(int newMinVal)
  {
    ...
    minVal = newMinVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_SUCCESSION__MIN_VAL, oldMinVal, minVal));
  }
  ...
  public void setMaxVal(int newMaxVal)
  {
    ...
    maxVal = newMaxVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.CHAIN_SUCCESSION__MAX_VAL, oldMaxVal, maxVal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SclPackage.CHAIN_SUCCESSION__REF_A:
        return ((InternalEList<?>)getRefA()).basicRemove(otherEnd, msgs);
      case SclPackage.CHAIN_SUCCESSION__REF_B:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SclPackage.CHAIN_SUCCESSION__EITHER_A:
        return isEitherA();
      case SclPackage.CHAIN_SUCCESSION__REF_A:
        return getRefA();
      case SclPackage.CHAIN_SUCCESSION__EITHER_B:
        return isEitherB();
      case SclPackage.CHAIN_SUCCESSION__REF_B:
        return getRefB();
      case SclPackage.CHAIN_SUCCESSION__MIN_VAL:
        return getMinVal();
      case SclPackage.CHAIN_SUCCESSION__MAX_VAL:
        return getMaxVal();
    }
