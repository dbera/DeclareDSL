...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Not Succession</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.NotSuccessionImpl#isEitherA <em>Either A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.NotSuccessionImpl#getRefA <em>Ref A</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.NotSuccessionImpl#isEitherB <em>Either B</em>}</li>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.NotSuccessionImpl#getRefB <em>Ref B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotSuccessionImpl extends MinimalEObjectImpl.Container implements NotSuccession
{
  /**
  ...
  {
    return SclPackage.Literals.NOT_SUCCESSION;
  }
  ...
  public void setEitherA(boolean newEitherA)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.NOT_SUCCESSION__EITHER_A, oldEitherA, eitherA));
  }
  ...
  public EList<Ref> getRefA()
  {
    if (refA == null)
    {
      refA = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.NOT_SUCCESSION__REF_A);
    }
    return refA;
  }
  ...
  public void setEitherB(boolean newEitherB)
  {
    ...
    eitherB = newEitherB;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.NOT_SUCCESSION__EITHER_B, oldEitherB, eitherB));
  }
  ...
  public EList<Ref> getRefB()
  {
    if (refB == null)
    {
      refB = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.NOT_SUCCESSION__REF_B);
    }
    return refB;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SclPackage.NOT_SUCCESSION__REF_A:
        return ((InternalEList<?>)getRefA()).basicRemove(otherEnd, msgs);
      case SclPackage.NOT_SUCCESSION__REF_B:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SclPackage.NOT_SUCCESSION__EITHER_A:
        return isEitherA();
      case SclPackage.NOT_SUCCESSION__REF_A:
        return getRefA();
      case SclPackage.NOT_SUCCESSION__EITHER_B:
        return isEitherB();
      case SclPackage.NOT_SUCCESSION__REF_B:
        return getRefB();
    }
