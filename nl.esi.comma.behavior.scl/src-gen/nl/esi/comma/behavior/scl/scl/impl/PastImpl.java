 ...
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.PastImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PastImpl extends MinimalEObjectImpl.Container implements Past
{
  /**
  ...
  {
    return SclPackage.Literals.PAST;
  }
  ...
  public EList<EObject> getType()
  {
    if (type == null)
    {
      type = new EObjectContainmentEList<EObject>(EObject.class, this, SclPackage.PAST__TYPE);
    }
    return type;
  }
