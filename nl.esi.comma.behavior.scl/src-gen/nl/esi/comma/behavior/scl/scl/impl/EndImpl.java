 ...
 * </p>
 * <ul>
 *   <li>{@link nl.esi.comma.behavior.scl.scl.impl.EndImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndImpl extends MinimalEObjectImpl.Container implements End
{
  ...
  {
    return SclPackage.Literals.END;
  }
  ...
  public EList<Ref> getRef()
  {
    if (ref == null)
    {
      ref = new EObjectContainmentEList<Ref>(Ref.class, this, SclPackage.END__REF);
    }
    return ref;
  }
